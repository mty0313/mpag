...
import top.diff.mpag.remote.OpenAIClient;
...
public class WxArticleController {
  ...
  @PostMapping("/post")
  public String post(@RequestBody WxArticlesPost post) {
    OpenAIChatReq chatReq = buildOpenAIChatReq4Articles();
    String resp = openAIClient.chat(chatReq);
